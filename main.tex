...
% ==================================================
% PAQUETES PARA EVITAR DESBORDAMIENTOS DE TEXTO
% ==================================================
\usepackage[utf8]{inputenc}
\usepackage[T1]{fontenc}
\usepackage{lmodern}     % Fuente escalable que ayuda con la microtipografía
\usepackage{microtype}   % Mejora la justificación del texto y corta palabras adecuadamente
\usepackage[hyphens]{url}% Permite cortar URLs cuando se usan \url{} o \href{}
\usepackage{hyperref}
\usepackage{breakcites}  % Si fuera necesario para cortar citas muy largas
\sloppy                  % Opción rápida para evitar desbordamientos
\emergencystretch=1em    % Ajusta la separación extra cuando el texto no cabe en la línea
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{imagec.png} % 0.9 o 1.0 según prefieras
